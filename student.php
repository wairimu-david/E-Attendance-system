 ...
 <div class="container">
  ...
  <form id="getAttendance">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="roll" placeholder="Eg - CT207/100878/19">
   ...
   <!-- FOOTER -->
      <footer style="background:; height:;">
        ...
        <p>&copy; YEAR 2022 Project, Inc. &middot;  developed by  <a href="https://www.facebook.com/profile.php?id=100011741650719">Da Ve</a>Privacy</a> &middot; </p>
      </footer>
