        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. CT207/100878/19)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. CT265/200001/19)">
